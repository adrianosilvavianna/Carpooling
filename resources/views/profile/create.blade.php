        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control"  name="profile[name]" id="name_id">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control"  name="profile[email]" id="email_id" >
                    </div>
                </div>
                <div class="form-group">
                    <label for="cpf_id" class="col-sm-2 control-label">Cpf</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="profile[cpf]" id="cpf_id" >
                    </div>
                </div>
                <div class="form-group">
                    <label for="phone_id" class="col-sm-2 control-label">Telefone</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="profile[phone]" id="phone_id" >
                    </div>
                </div>
            </div>
